...
4. Navigate to the folder containing the "kakuyomu-list-mark" extension files. 
5. Select the folder and click "Open" or "Select Folder" to load the extension.
6. Read plugin instruction.